...
if ('geolocation' in navigator) {
  ...
  // API HOSPEDAGEM
    ...
    const hospedagem_api = `https://api.geoapify.com/v2/places?categories=accommodation.hotel&filter=circle:${lon},${lat},5000&bias=proximity:${lon},${lat}&limit=20&apiKey=${key_api}`;
